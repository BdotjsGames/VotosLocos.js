class Taco extends ItemPickup{
    constructor(x,y,w,h) {
        super('Taco',IMAGES.taco,x,y,w,h)
    }
    onPickup(player) {
        this.player = player;
        this.scene.playDialogue(
            [
                ...
                {text: player.health>=player.maxHealth?"<color red>Your health is full!":"<color red>10 hp healed", zoom: 2},
